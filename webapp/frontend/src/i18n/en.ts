...
export const en: Record<keyof typeof cn, string> = {
  ...
  'dashboard.excludedNoticePrefix': '{ids} excluded from comparison due to data gaps; see the ',
  'dashboard.excludedNoticeSuffix': ' page for details',
  ...
  'funds.viewRbaHistory': 'View RBA rate history',
  'funds.colId': 'Fund ID',
  ...
  'funds.viewData': 'View data',
  'funds.hideHint': 'Hidden funds do not appear on the dashboard',
  'funds.unhide': 'Unhide',
  'funds.hide': 'Hide',
  'funds.delete': 'Delete',
  'funds.deleteConfirmPrompt': 'Confirm delete?',
  'funds.yes': 'Yes',
  'funds.no': 'No',
  'funds.emptyState': 'No funds yet. Click "+ Add fund" in the top right to start an LLM ingest job.',
  'funds.addPanelTitle': 'Add fund (LLM ingest)',
  'funds.nameLabel': 'Fund name',
  'funds.onlyRequired': '(only required field)',
  'funds.namePlaceholder': 'e.g. Bentham Global Income Fund',
  'funds.autoIngestHint': 'After submitting, Gemini automatically searches the web for the archive page and extracts monthly data.',
  'funds.searchEngine': 'Search engine',
  'funds.engineTavily': 'Tavily (fast, deterministic)',
  'funds.engineGrok': 'Grok (slow, 15-20s, answers directly)',
  'funds.advancedOptions': 'Advanced options (all optional; speeds up search / pinpoints errors)',
  ...
  'funds.progressLog': 'Progress log (last {n} lines):',
  'funds.closeJobPanel': 'Close (ingest keeps running in the background)',
  'funds.reviewTitle': 'Pending review: {fundId} ({n})',
  'funds.noPending': 'No pending records',
  'funds.reviewReasonLabel': 'Gate rejected',
  'funds.approveLabel': 'Approve (write to monthly_returns)',
  'funds.reject': 'Reject',
  ...
  'funds.returnsDrawerTitle': '{name} monthly net return ({n})',
